...
impl VideoDecodeH264FieldLayoutFlagsEXT {
    pub const VIDEO_DECODE_H264_PROGRESSIVE_PICTURES_ONLY: Self = Self(0);
...
impl VideoEncodeH264CapabilitiesFlagsEXT {
    pub const VIDEO_ENCODE_H264_CAPABILITY_CABAC: Self = Self(0b1);
    pub const VIDEO_ENCODE_H264_CAPABILITY_CAVLC: Self = Self(0b10);
    pub const VIDEO_ENCODE_H264_CAPABILITY_WEIGHTED_BI_PRED_IMPLICIT: Self = Self(0b100);
    pub const VIDEO_ENCODE_H264_CAPABILITY_TRANSFORM_8X8: Self = Self(0b1000);
    pub const VIDEO_ENCODE_H264_CAPABILITY_CHROMA_QP_OFFSET: Self = Self(0b1_0000);
    pub const VIDEO_ENCODE_H264_CAPABILITY_SECOND_CHROMA_QP_OFFSET: Self = Self(0b10_0000);
    pub const VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_DISABLED: Self = Self(0b100_0000);
    pub const VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_ENABLED: Self = Self(0b1000_0000);
    pub const VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_PARTIAL: Self = Self(0b1_0000_0000);
    pub const VIDEO_ENCODE_H264_CAPABILITY_MULTIPLE_SLICE_PER_FRAME: Self = Self(0b10_0000_0000);
    pub const VIDEO_ENCODE_H264_CAPABILITY_EVENLY_DISTRIBUTED_SLICE_SIZE: Self =
