...
impl fmt::Debug for AccessFlags2KHR {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        const KNOWN: &[(Flags64, &str)] = &[
            ...
            (
                AccessFlags2KHR::ACCESS_2_VIDEO_DECODE_READ.0,
                "ACCESS_2_VIDEO_DECODE_READ",
            ),
            (
                AccessFlags2KHR::ACCESS_2_VIDEO_DECODE_WRITE.0,
                "ACCESS_2_VIDEO_DECODE_WRITE",
            ),
            (
                AccessFlags2KHR::ACCESS_2_VIDEO_ENCODE_READ.0,
                "ACCESS_2_VIDEO_ENCODE_READ",
            ),
            (
                AccessFlags2KHR::ACCESS_2_VIDEO_ENCODE_WRITE.0,
                "ACCESS_2_VIDEO_ENCODE_WRITE",
            ),
            (
...
impl fmt::Debug for PipelineStageFlags2KHR {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        const KNOWN: &[(Flags64, &str)] = &[
            ...
            (
                PipelineStageFlags2KHR::PIPELINE_STAGE_2_VIDEO_DECODE.0,
                "PIPELINE_STAGE_2_VIDEO_DECODE",
            ),
            (
                PipelineStageFlags2KHR::PIPELINE_STAGE_2_VIDEO_ENCODE.0,
                "PIPELINE_STAGE_2_VIDEO_ENCODE",
            ),
            (
...
impl fmt::Debug for VideoDecodeH264FieldLayoutFlagsEXT {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        const KNOWN: &[(Flags, &str)] = &[
            (
                VideoDecodeH264FieldLayoutFlagsEXT::VIDEO_DECODE_H264_PROGRESSIVE_PICTURES_ONLY.0,
                "VIDEO_DECODE_H264_PROGRESSIVE_PICTURES_ONLY",
            ),
            (
...
impl fmt::Debug for VideoEncodeH264CapabilitiesFlagsEXT {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        const KNOWN : & [(Flags , & str)] = & [(VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_CABAC . 0 , "VIDEO_ENCODE_H264_CAPABILITY_CABAC") , (VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_CAVLC . 0 , "VIDEO_ENCODE_H264_CAPABILITY_CAVLC") , (VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_WEIGHTED_BI_PRED_IMPLICIT . 0 , "VIDEO_ENCODE_H264_CAPABILITY_WEIGHTED_BI_PRED_IMPLICIT") , (VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_TRANSFORM_8X8 . 0 , "VIDEO_ENCODE_H264_CAPABILITY_TRANSFORM_8X8") , (VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_CHROMA_QP_OFFSET . 0 , "VIDEO_ENCODE_H264_CAPABILITY_CHROMA_QP_OFFSET") , (VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_SECOND_CHROMA_QP_OFFSET . 0 , "VIDEO_ENCODE_H264_CAPABILITY_SECOND_CHROMA_QP_OFFSET") , (VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_DISABLED . 0 , "VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_DISABLED") , (VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_ENABLED . 0 , "VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_ENABLED") , (VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_PARTIAL . 0 , "VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_PARTIAL") , (VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_MULTIPLE_SLICE_PER_FRAME . 0 , "VIDEO_ENCODE_H264_CAPABILITY_MULTIPLE_SLICE_PER_FRAME") , (VideoEncodeH264CapabilitiesFlagsEXT :: VIDEO_ENCODE_H264_CAPABILITY_EVENLY_DISTRIBUTED_SLICE_SIZE . 0 , "VIDEO_ENCODE_H264_CAPABILITY_EVENLY_DISTRIBUTED_SLICE_SIZE")] ;
        debug_flags(f, KNOWN, self.0)
    }
}
